    ...
    <div className="flex gap-3">
      ...
      <div className="flex flex-col">
        <div className="flex items-center gap-1">
          <p className="font-['Oswald',_system-ui,_sans-serif] text-sm text-[#2C2F24]">
            {card.name}
          </p>
          <svg
            className="mt-0.5"
    ...
    <div className="flex items-center justify-between text-slate-500 text-xs">
      <div className="flex items-center gap-1">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="hover:text-[#AD343E] transition-colors"
        >
          <svg
            width="11"
            height="10"
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-10 space-y-6">
          <div className="marquee-row w-full mx-auto overflow-hidden relative">
            ...
            <div className="absolute right-0 top-0 h-full w-20 md:w-40 z-10 pointer-events-none bg-gradient-to-l from-[#F9F9F7] to-transparent" />
          </div>
          <div className="marquee-row w-full mx-auto overflow-hidden relative">
            <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none bg-gradient-to-r from-[#F9F9F7] to-transparent" />
            <div className="marquee-inner marquee-reverse flex transform-gpu min-w-[200%] pt-6 pb-3">
              {[...cardsData, ...cardsData].map((card, index) => (
                <CreateCard key={index} card={card} />
              ))}
            </div>
